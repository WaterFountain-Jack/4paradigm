...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    if "图形推理" in text_prompt:
        ...
        # prompt = "Now pretend you are gpt-4" + text_prompt + "Before answering the question, let's think step by step."   
        prompt = "Take a deep breath" + text_prompt + "Before answering the question, let's think step by step."   

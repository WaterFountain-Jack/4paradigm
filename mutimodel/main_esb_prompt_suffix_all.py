...
def create_chat_completion(request: ChatCompletionRequest):
    ...
    if "图形推理" in text_prompt:
        ...
        prompt = text_prompt + suffix1_cn+"请从（A, B, C, D）中选择一个选项。"
        generation_config = dict(
            num_beams=3,
            max_new_tokens=1024, 
            do_sample=False,
    ...
    # sometime 26b/8b
       ...
       # 26b
        ...
        prompt = "You are very good at mathematical analysis" + text_prompt + suffix1

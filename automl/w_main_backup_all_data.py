...
eid_wanbolv_rate = pd.read_pickle('/root/test/m10/xgboost/eid_wanbolv_rate.pkl')
...
def predict():
    ...
    #出现次数为1的平均值为： 0.032274722437387035 0.032274722437387035
    ...
    df.fillna(value={'eid_count':1}, inplace=True)
    df.fillna(value={'eid_wanbolv':1}, inplace=True)
